"""
Django settings for lanest_42062 project.
...
ROOT_URLCONF = 'lanest_42062.urls'
...
WSGI_APPLICATION = 'lanest_42062.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lanest_42062 API",
    "DESCRIPTION": "API documentation for lanest_42062 App",
    "VERSION": "v1",
}
